...
int SyscallHandler::execute_syscall(uint64_t n, uint64_t _a0, uint64_t _a1, uint64_t _a2, uint64_t) {
	...
	switch (n) {
		...
		case SYS_host_error:
			//std::cout << "SYS_host_error" << std::endl;
